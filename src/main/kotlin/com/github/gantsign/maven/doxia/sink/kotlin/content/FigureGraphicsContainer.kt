...
interface FigureGraphicsContainer {
    ...
    fun figureGraphics(
        ...
        sink.figureGraphics(
            src,
            attributesOf(
                SinkEventAttributes.ALT to alt,
                ...
                SinkEventAttributes.HSPACE to hSpace,
                SinkEventAttributes.VSPACE to vSpace,
                SinkEventAttributes.ISMAP to isMap,
                SinkEventAttributes.USEMAP to useMap,
