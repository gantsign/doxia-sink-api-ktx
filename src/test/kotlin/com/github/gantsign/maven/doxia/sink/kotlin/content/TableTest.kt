...
class TableTest {
    ...
    fun `no args`() {
        ...
        argumentCaptor<SinkEventAttributes>().apply {
            ...
            assertThat(firstValue[SinkEventAttributes.CELLPADDING]).isNull()
            assertThat(firstValue[SinkEventAttributes.CELLSPACING]).isNull()
            assertThat(firstValue[SinkEventAttributes.FRAME]).isNull()
            assertThat(firstValue[SinkEventAttributes.RULES]).isNull()
            assertThat(firstValue[SinkEventAttributes.SUMMARY]).isNull()
    ...
    fun `with args`() {
        ...
        argumentCaptor<SinkEventAttributes>().apply {
            ...
            assertThat(firstValue[SinkEventAttributes.CELLPADDING]).isEqualTo("cellPadding1")
            assertThat(firstValue[SinkEventAttributes.CELLSPACING]).isEqualTo("cellSpacing1")
            assertThat(firstValue[SinkEventAttributes.FRAME]).isEqualTo("frame1")
            assertThat(firstValue[SinkEventAttributes.RULES]).isEqualTo("rules1")
            assertThat(firstValue[SinkEventAttributes.SUMMARY]).isEqualTo("summary1")
